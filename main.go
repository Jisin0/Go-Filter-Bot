...
func main() {
	...
	dispatcher.AddHandlerToGroup(handlers.NewMessage(customfilters.AllGroup, plugins.FilterHandler), 1)
	...
	dispatcher.AddHandlerToGroup(handlers.NewCommand("filter", plugins.NewFilter), 2)
	dispatcher.AddHandlerToGroup(handlers.NewCommand("gfilter", plugins.NewFilter), 2)
	dispatcher.AddHandlerToGroup(handlers.NewCommand("filters", plugins.AllMfilters), 2)
	dispatcher.AddHandlerToGroup(handlers.NewCommand("stop", plugins.StopMfilter), 2)
